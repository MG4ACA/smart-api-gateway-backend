...
describe('Recipe Endpoints', () => {
  describe('GET /api/recipes/categories', () => {
    it('should get recipe categories successfully', async () => {
      const response = await request(app).get('/api/recipes/categories').expect(200);
  ...
  describe('GET /api/recipes/random', () => {
    it('should get a random recipe successfully', async () => {
      const response = await request(app).get('/api/recipes/random').expect(200);
  ...
  describe('GET /api/recipes/search', () => {
    it('should search recipes successfully', async () => {
      const response = await request(app).get('/api/recipes/search?q=chicken').expect(200);
    ...
    it('should return error for empty search term', async () => {
      const response = await request(app).get('/api/recipes/search?q=').expect(400);
    ...
    it('should return error for short search term', async () => {
      const response = await request(app).get('/api/recipes/search?q=a').expect(400);
  ...
  describe('GET /api/recipes/category/:category', () => {
    it('should get recipes by category successfully', async () => {
      const response = await request(app).get('/api/recipes/category/Seafood').expect(200);
  ...
  describe('GET /api/recipes/:id', () => {
    it('should get recipe by ID successfully', async () => {
      ...
      const response = await request(app).get('/api/recipes/52874').expect(200);
    ...
    it('should return 404 for non-existent recipe ID', async () => {
      const response = await request(app).get('/api/recipes/999999').expect(404);
