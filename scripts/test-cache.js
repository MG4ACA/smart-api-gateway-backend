...
async function main(){
  ...
  try{
    ...
    console.log('First request status:', r1.status, `time=${t1d}s`, 'items=', (r1.data?.data?.recipes||[]).length);
    ...
    console.log('Second request status:', r2.status, `time=${t2d}s`, 'items=', (r2.data?.data?.recipes||[]).length);
